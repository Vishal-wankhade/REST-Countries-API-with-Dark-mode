...
function changeTheme() {
  if (mode === "dark") {
    ...
    moon.src = "images/moon-regular.svg";
    searchIcon.src = "images/search-regular.svg";
    arrow.src = "images/arrow-left-regular.svg";
  } else {
    root.style.setProperty("--bg", "#fafafa");
    root.style.setProperty("--text", "#111517");
    root.style.setProperty("--lbg", "#ffffff");
    moon.src = "images/moon-solid.svg";
    searchIcon.src = "images/search-solid.svg";
    arrow.src = "images/arrow-left-solid.svg";
  }
}
